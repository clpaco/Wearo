// Modelo Social — feed público de outfits compartidos y likes
...
module.exports = { shareOutfit, unshareOutfit, getFeed, getMyShared, addLike, removeLike, getLikeCount, isShared };
